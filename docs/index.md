...
features:
  - icon: 🏢
    ...
    details: Manage all your teams from one dashboard. Assign head coaches, track team status, and control organization-level access — available on Organization and Enterprise plans.
    link: /organization/
    linkText: Learn more
  ...
  - icon: 📋
    title: Coach Notes with AI
    details: Speak or type coaching observations. AI extracts player-specific insights and connects them to training plans.
    link: /coach-notes/
    linkText: Learn more

  - icon: ⚾
    title: Score Every Play
    details: Log every pitch, at-bat, fielding play, and baserunning event in real time using manual entry or voice logging.
    link: /scoring-games/
    linkText: Learn more

  - icon: 🎙️
    title: Voice Logging
    details: Describe plays naturally using your voice. AI interprets the play and logs it to the correct fields automatically.
    link: /voice-logging/
    linkText: Learn more

  - icon: 📊
    title: Analytics That Drive Development
    details: Heat maps, spray charts, polar accuracy charts, and quality at-bat percentage give coaches objective data on every player — with age-appropriate benchmarks and automatic training suggestions built in.
    link: /analytics/
    linkText: Learn more

  - icon: 📄
    title: Player Report Cards
  ...
  - icon: 🎯
    ...
    details: The app analyzes player data and automatically suggests training focus areas with drill search powered by YouTube.
    link: /training/
    linkText: Learn more
