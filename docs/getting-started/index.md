...
**After games and practices** — coaches review player and team analytics, identify development priorities, and create training plans. The suggestion engine automatically flags areas needing attention based on statistical thresholds.

**Throughout the season** — player report cards track development over time and can be shared with families. Mechanics assessments document technique alongside statistics.
...
- All analytics, mechanics assessments, and training plans work identically for both sports
- A coach managing both baseball and softball teams uses a single subscription
